...
export const en: TranslationMap = {
  ...
  heartbeat: {
    title: "Heartbeat",
    subtitle: "Scheduling status and interval configuration.",
    interval: "Interval",
    intervalHint: "How often the heartbeat runs. Examples: 30m, 1h, 4h, 12h.",
    presets: {
      "30m": "30 min",
      "1h": "1 hour",
      "4h": "4 hours",
    ...
    sinceStartup: "Since this startup",
    disabled: "Heartbeat is not enabled for this agent.",
    loading: "Loading heartbeat status...",
    error: "Failed to load heartbeat status.",
    refresh: "Refresh",
    customPlaceholder: "e.g. 45m",
    invalidFormat: "Invalid format. Use a number followed by s, m, h, or d.",
    saving: "Saving...",
    save: "Save",
  },
};
